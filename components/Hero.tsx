          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
           ...
           <div className="text-center">
             ...
             <div className="flex flex-wrap justify-center gap-4">
               ...
               <Link href="/contact" className="text-gray-800 hover:text-pink-400 transition-all duration-300 text-sm font-medium hover:scale-110 transform bg-gradient-to-r from-pink-500/10 to-purple-500/10 backdrop-blur-md border border-pink-400/20 rounded-full px-4 py-2 hover:shadow-lg hover:shadow-pink-500/20">
                 Get In Touch →
               </Link>
             </div>
           </div>
